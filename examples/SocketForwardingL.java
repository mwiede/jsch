 ...
 * $ CLASSPATH=.:../build javac SocketForwardingL.java
 * $ CLASSPATH=.:../build java SocketForwardingL
 * You will be asked username, hostname and passwd.
 * If everything works fine, you will get the response code to the _ping endpoint of the dockerd.
 */
